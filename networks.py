...
class TransformerNet(nn.Module):
    def __init__(self, embedding_dim, num_mappings, num_heads, num_blocks, seq_length, padding_idx=0):
        ...
        self.hyper_params = [embedding_dim, num_mappings, num_heads, num_blocks, seq_length, padding_idx]
    ...
    @classmethod
    def load_checkpoint(cls, checkpoint_path: str) -> 'TransformerNet':
        checkpoint: dict = torch.load(checkpoint_path)
        hyper_params = checkpoint["hyper_params"]
        net = cls(*hyper_params)
